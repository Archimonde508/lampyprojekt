...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'be-ps1_db-1', 'port' => '', 'dbname' => 'ps', 'user' => 'ps', 'password' => 'ps', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('s2xx0PYiCxLqMSTnwFypR0LKfyiER4ubaKjvxWyfBTXe9kigpyRnW8ML');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('61802e6cedbca6.40979486')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 's2xx0PYiCxLqMSTnwFypR0LKfyiER4ubaKjvxWyfBTXe9kigpyRnW8ML',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2021-11-01',
            'locale' => 'pl-PL',
            'cookie_key' => 'jtuNsxiv8Vo70m38G7rSbYOLNv2UYpabJwOXPJ4USrXeUj9d6qN63pER',
            'cookie_iv' => 'IgXhZ64t',
            'new_cookie_key' => 'def00000678d0627916366d2edc902a5e59bcd3fc4db77fbcc1faf47f159f3113e9374eb5a654f947b7dae35d6a76cd89df65fecd4def1ccb67180e65b1e520d1db0f5bb',
            ...
            'kernel.secret' => 's2xx0PYiCxLqMSTnwFypR0LKfyiER4ubaKjvxWyfBTXe9kigpyRnW8ML',
